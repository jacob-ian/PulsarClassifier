package com.scienceguyrob.lotaasclassifier.stats;
 ...
 * <p/>
 * File name:   ClassifierStats.java
 * Created:     23/10/2016
 * Author:      Rob Lyon
 * <p/>
 ...
 */
public class ClassifierStats implements I_ClassifierStats
{
    //*****************************************
    //*****************************************
    //              Variables
     ...
     */
    public ClassifierStats(double tp,double tn,double fp,double fn)
    {
        this.TP = tp;
        this.TN = tn;
        this.FP = fp;
