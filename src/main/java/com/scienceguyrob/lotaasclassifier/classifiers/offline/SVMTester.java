...
/**
 * The class SVMTester tests the SVM implementation of a decision tree from Weka.
 *
 * @author Rob Lyon
 *
 * @version 1.0, 05/03/13
 */
public class SVMTester extends WekaClassifier implements I_WekaTest
{
    //*****************************************
    //*****************************************
    //              Variables
     ...
     */
    private SMO learner = new SMO();

    /**
     * The name of the classifier.
     */
    private String name = "SVM";
     ...
     */
    public SVMTester(BasicLogger l, String n){ super(l,n); }
     ...
     * @param n the name of the class.
     */
    public SVMTester(String n){ super(n);}
    ...
    public SMO getClassifier(){ return this.learner; }
