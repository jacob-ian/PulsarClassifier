...
/**
 * The class MLPTester tests the MLP implementation of a decision tree from Weka.
 *
 * @author Rob Lyon
 *
 * @version 1.0, 05/03/13
 */
public class MLPTester extends WekaClassifier implements I_WekaTest
{
    //*****************************************
    //*****************************************
    //              Variables
     ...
     */
    private MultilayerPerceptron learner = new MultilayerPerceptron();

    /**
     * The name of the classifier.
     */
    private String name = "MLP";
     ...
     */
    public MLPTester(BasicLogger l, String n){ super(l,n); }
     ...
     * @param n the name of the class.
     */
    public MLPTester(String n){ super(n);}
    ...
    public MultilayerPerceptron getClassifier(){ return this.learner; }
    ...
    public boolean loadModel(String path)
    {
        try
        {
            ...
            MultilayerPerceptron cls = (MultilayerPerceptron) ois.readObject();
            ois.close();
    ...
    public boolean reset()
    {
        ...
        try
        {
            stats.reset();
            learner = null;
            learner = new MultilayerPerceptron();
